...
[NM,meths] = eval_method_sparse_gpc(DO_HYP);
    ...
    for nk = 1:NK % loop over CV averaging run
        ...
        for k = 1:K % loop over CV fold
            ...
            for nm = 1:NM % loop over methods
                ...
                ] = eval_method_sparse_gpc(DO_HYP,nm,data_train,data_test,ix_train_inducing,...
...
clear ixtest ixtrain ixrest this_ix_train;
save(fn_output,'-v6');
