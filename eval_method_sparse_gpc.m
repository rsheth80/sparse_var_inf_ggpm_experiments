...
function [varargout] = eval_method_sparse_gpc(DO_HYP,imeth,data_train,data_test,ix_inducing,varargin)
% function [varargout] = eval_method_sparse_gpc(DO_HYP,imeth,data_train,data_test,ix_inducing,varargin)
%
...
meths_cell = {
    ...
    'sparse_gpc', models(4), @gen_gp_train, @gen_gp_predict, ...
        { ...
            @f_obj_primal_m, opts_m; ...
            @fp_opt, opts_V;
            }, ...
        'sp_gpc_fp', {'color','b', 'linestyle','-', 'marker','n'};...

%    'sparse_gpc', models(4), @gen_gp_train, @gen_gp_predict, ...
%        { ...
%            @full_var_opt_dm_fpV, {}; ...
%            }, ...
%        'sp_gpc_full', {'color','g', 'linestyle','-', 'marker','n'};...
    ...
    'sparse_gpc', models(4), @gen_gp_train, @gen_gp_predict, ...
        ...
        'sp_gpc_grad', {'color','c', 'linestyle','-', 'marker','n'};...
       
%    'sparse_gpc', models(4), @gen_gp_train, @gen_gp_predict, ...
%        { ...
%            @f_obj_dual_l, opts_ls ...
%            }, ...
%        'sp_gpc_dual', {'color',[0 .5 0], 'linestyle','-', 'marker','n'};...
