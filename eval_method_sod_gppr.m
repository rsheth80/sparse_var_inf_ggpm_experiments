...
function [varargout] = eval_method_sod_gppr(DO_HYP,imeth,data0,ixtrain,ixtest,ixtrain_inducing,varargin)
% function [varargout] = eval_method_sod_gppr(DO_HYP,imeth,data0,ixtrain,ixtest,ixtrain_inducing,varargin)
%
...
meths_cell = {
    ...
    'sod_gppr', models(1), @gen_gp_train, @gen_gp_predict, ...
        { ...
            @f_obj_primal_m, opts_m; ...
            @fp_opt, opts_V;
            }, ...
        'sod_gppr_fp', {'color','b', 'linestyle','--', 'marker','n'};...
    ...
    'sod_gppr', models(1), @gen_gp_train, @gen_gp_predict, ...
        ...
        'sod_gppr_grad', {'color','c', 'linestyle','--', 'marker','n'};...

    'sod_gppr', models(1), @gen_gp_train, @gen_gp_predict, ...
        { ...
            @f_obj_laplace, opts_la; ...
            }, ...
        'sod_gppr_la', {'color','r', 'linestyle','--', 'marker','n'};...

    'sod_gppr', models(1), @gen_gp_train, @gen_gp_predict, ...
        { ...
            @f_obj_dual_l, opts_ls ...
            }, ...
        'sod_gppr_dual', {'color',[0 .5 0], 'linestyle','--', 'marker','n'};...
