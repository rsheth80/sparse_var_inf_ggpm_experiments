...
function sparse_exp_gpo

DO_HYP = 0;

% load data set
fn = 'ordinal_dataset_SEiso_zero_L5_N1000_D10.mat';
fn = 'ordinal_dataset_bank32nh_L10_N8192_D32.mat';
fn = 'ordinal_dataset_movielens_N4662_D42.mat';
fn = 'ordinal_dataset_stock_L5_N950_D9.mat';
%fn = 'ordinal_dataset_calhousing_L5_N20640_D8.mat';
...
[NM,meths] = eval_method_sparse_gpo(DO_HYP);
    ...
    for nk = 1:NK % loop over CV averaging run
        ...
        for k = 1:K % loop over CV fold
            ...
            for nm = 1:NM % loop over methods
                ...
                ] = eval_method_sparse_gpo(DO_HYP,nm,data_train,data_test,ix_train_inducing,...
