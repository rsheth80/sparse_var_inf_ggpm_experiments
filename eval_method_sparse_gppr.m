...
function [varargout] = eval_method_sparse_gppr(DO_HYP,imeth,data_train,data_test,ix_inducing,varargin)
% function [varargout] = eval_method_sparse_gppr(DO_HYP,imeth,data_train,data_test,ix_inducing,varargin)
%
...
meths_cell = {
    ...
    'sparse_gppr', models(1), @gen_gp_train, @gen_gp_predict, ...
        { ...
            @f_obj_primal_m, opts_m; ...
            @fp_opt, opts_V;
            }, ...
        'sp_gppr_fp', {'color','b', 'linestyle','-', 'marker','n'};...
   ...
   'sparse_gppr', models(1), @gen_gp_train, @gen_gp_predict, ...
       ...
       'sp_gppr_grad', {'color','c', 'linestyle','-', 'marker','n'};...
        
    'sparse_gppr', models(1), @gen_gp_train, @gen_gp_predict, ...
        { ...
            @f_obj_dual_l, opts_ls ...
            }, ...
        'sp_gppr_dual', {'color',[0 .5 0], 'linestyle','-', 'marker','n'};...
...
% train (below, data is equal to data_train; bad var naming on my part)
ttr=cputime;
