...
function [varargout] = eval_method_sod_gpc(DO_HYP,imeth,data0,ixtrain,ixtest,ixtrain_inducing,varargin)
% function [varargout] = eval_method_sod_gpc(DO_HYP,imeth,data0,ixtrain,ixtest,ixtrain_inducing,varargin)
%
...
meths_cell = {
    ...
    'sod_gpc', models(4), @gen_gp_train, @gen_gp_predict, ...
        { ...
            @f_obj_primal_m, opts_m; ...
            @fp_opt, opts_V;
            }, ...
        'sod_gpc_fp', {'color','b', 'linestyle','--', 'marker','n'};...

%    'sod_gpc', models(4), @gen_gp_train, @gen_gp_predict, ...
%        { ...
%            @full_var_opt_dm_fpV, {}; ...
%            }, ...
%        'sod_gpc_full', {'color','g', 'linestyle','-', 'marker','n'};...
    ...
    'sod_gpc', models(4), @gen_gp_train, @gen_gp_predict, ...
        ...
        'sod_gpc_grad', {'color','c', 'linestyle','--', 'marker','n'};...

%   'sod_gpc', models(4), @gen_gp_train, @gen_gp_predict, ...
%      { ...
%          @f_obj_laplace, opts_la; ...
%          }, ...
%      'sod_gpc_la', {'color','r', 'linestyle','--', 'marker','n'};...

%    'sod_gpc', models(4), @gen_gp_train, @gen_gp_predict, ...
%        { ...
%            @f_obj_dual_l, opts_ls ...
%            }, ...
%        'sod_gpc_dual', {'color',[0 .5 0], 'linestyle','--', 'marker','n'};...
